          ...
          >
            ...
            <div v-if="message.role === 'ai'" class="ai-message">
              ...
              <div class="message-btn">
                ...
                >
                  <svg v-if="!copyStatus[index]" class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="14" height="14">
